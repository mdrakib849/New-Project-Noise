"""
Django settings for NoiseProject project.
...
SECRET_KEY = 'django-insecure-kl@si#$m$d19sv$h)3&%pfz7*u4q(dme8vb^+*%!)8(a@%u0ja'
...
ROOT_URLCONF = 'NoiseProject.urls'
...
WSGI_APPLICATION = 'NoiseProject.wsgi.application'
